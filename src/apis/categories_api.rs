...
/// Update a category
pub async fn update_category(configuration: &configuration::Configuration, budget_id: &str, category_id: &str, data: crate::models::PatchCategoryWrapper) -> Result<crate::models::SaveCategoryResponse, Error<UpdateCategoryError>> {
    let local_var_configuration = configuration;
...
pub async fn update_month_category(configuration: &configuration::Configuration, budget_id: &str, month: String, category_id: &str, data: crate::models::PatchMonthCategoryWrapper) -> Result<crate::models::SaveCategoryResponse, Error<UpdateMonthCategoryError>> {
    let local_var_configuration = configuration;
